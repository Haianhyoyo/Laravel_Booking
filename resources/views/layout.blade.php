                      ...
                      <nav class="menunav">
                         <ul class="ulwap-mainmenu">
                            ...
                            <li class="megamenusub" style="border-color:white">
                               <a href="{{route('tour',['du-lich-noi-dia.html'])}}" class=" 'active' ">
                               Du lịch trong nước
                               </a>
                               <ul>
                                  ...
                                  <li class="" style="border-color:white">
                                     <a href="{{route('tour',['du-lich-noi-dia.html'])}}" class="">
          ...
          <div class="col-md-12 col-xs-12 top-30 lst-tour-position">
             <div class="row">
                ...
                <div class="col-md-6 col-xs-12">
                   <div class="bximg-request-dd">
                      <a href="https://vietnamtravel.net.vn/vi/san-pham/139-du-lich-han-quoc.html">
                         <img src="{{asset('frontend/images/han-quoc.jp')}}g" alt="Du lịch Hàn Quốc">
                ...
                <div class="col-md-6 col-xs-12">
                   <div class="bximg-request-dd">
                      <a href="https://vietnamtravel.net.vn/vi/san-pham/156-du-lich-singapore-malaysia.html">
                         <img src="{{asset('frontend/images/du-lich-sin')}}g%20620x283.jpg" alt="Du lịch Singapore Malaysia">
                ...
                <div class="col-md-3 col-xs-6 cl-mb-half-4">
                   <div class="bximg-request-dd">
                      <a href="https://vietnamtravel.net.vn/vi/san-pham/156-du-lich-singapore-malaysia.html">
                         <img src="{{asset('frontend/images/Bali-%20Ind')}}o.jpg" alt="Du lịch Bali Indonesia">
          ...
          <div class="row">
             <div class="col-md-4 col-xs-12 bx-child-ph bx-child-ph1">
                ...
                <div class="w100 fl item-lst-pos1">
                   ...
                   <img src="{{asset('frontend/images/tin-tuc/du-lich-da-nang.jpg')}}" alt="Cẩm nang đi du lịch Đà Nẵng tất tần tật từ A -> Z vô cùng rẻ">
                   </a>
             ...
             <div class="col-md-4 col-xs-12 bx-child-ph bx-child-ph2">
                ...
                <div class="w100 fl item-lst-pos2">
                   <a href="https://vietnamtravel.net.vn/vi/ct/88-top-10-cong-ty-du-lich-hang-dau-hang-dau.html"><img src="{{asset('frontend/images/logo/Untitled-1.jpg')}}" alt="Tốp 10 công ty du lịch hàng đầu  hàng đầu"></a>
                ...
                <div class="w100 fl item-lst-pos2">
                   <a href="https://vietnamtravel.net.vn/vi/ct/82-hon-18-nam-kinh-nghiem.html"><img src="{{asset('frontend/images/logo/18_kinhnghiem_vn.jpg')}}" alt="Hơn 18 năm kinh nghiệm"></a>
                ...
                <div class="w100 fl item-lst-pos2">
                   <a href="https://vietnamtravel.net.vn/vi/ct/81-dich-vu-247.html"><img src="{{asset('frontend/images/logo/uytin_24_7.jpg')}}" alt="Dịch vụ 24/7"></a>
