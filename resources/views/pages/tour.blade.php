            ...
            <div class="col-md-4 col-xs-12 lst-tour-item">
               <div class="w100 fl bx-wap-pr-item">
                  <div class="clearfix box-wap-imgpr">
                     <a href="{{route('chi-tiet-tour',['du-lich-quy-nhon-567.html'])}}">
                  ...
                  <div class="clear"></div>
                  <h4><a href="{{route('chi-tiet-tour',['du-lich-quy-nhon-567.html'])}}">Tour Hot nhất Hè 2023 Quy Nhơn - Phú Yên (Xứ Nẫu đẹp nhất Việt Nam)</a></h4>
                  <div class="clear"></div>
                  ...
                  <div class="group-book w100 fl">
                     ...
                     <a href="{{route('chi-tiet-tour',['du-lich-quy-nhon-567.html'])}}" class="link-book btn_view_tour0">Xem chi tiết</a>
                  </div>
               </div>
            </div>
